...
export function SectionCare () {
    return (
        <section className="relative w-full flex items-center justify-center min-h-screen bg-[#ccfff9]" id="Care">
            <div className="w-full max-w-[1246px] px-[15px] mx-auto justify-center">
                    <div className="max-w-[1200px] mx-auto pt-12 lg:pt-24 text-center pb-12 justify-center align">
                        ...
                        <div className=" hover:bg-[#27b9a8] p-5  bg-primary-blue rounded-3xl shadow-lg m-4 flex flex-col items-center text-center">
                            ...
                            <div className="p-5  hover:bg-[#27b9a8] bg-primary-blue rounded-3xl shadow-lg m-4 flex flex-col items-center text-center">
